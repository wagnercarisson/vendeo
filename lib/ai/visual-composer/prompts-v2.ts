/**
 * Visual Composer Prompt V2 — Optimized for Performance
 * 
 * Changes from V1:
 * - Reduced prompt size from ~1700 tokens to ~1200 tokens
 * - Added 2 concrete JSON examples (few-shot learning)
 * - Removed redundant validation rules (moved to code)
 * - Simplified language for faster parsing
 * 
 * Target performance: <15s response time (down from 25s)
 * Target success rate: >95% (up from 25%)
 */

export const VISUAL_COMPOSER_SYSTEM_PROMPT_V2 = `<role>
...
<output>
{
  ...
  "canvas": { "width": 1080, "height": 1350 },
  "generated_at": "2026-04-25T10:05:00.000Z"
}
</output>
</example_2>
</examples>`;

export function buildVisualComposerUserPromptV2(payload: {
