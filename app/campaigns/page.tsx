...
export default function CampaignsPage() {
  ...
  // id da campanha que está gerando (para travar o clique)
  ...
  async function generateAndSave(campaign: Campaign, force = false) {
    // evita clique duplo enquanto gera
    ...
    try {
      ...
      // o backend já salva (idempotente + service role); aqui só atualizamos a tela
      await res.json();
      await loadCampaigns();
          ...
          return (
            ...
            >
              ...
              <div style={{ display: "flex", gap: 8, marginTop: 12 }}>
                <button
                  onClick={() => generateAndSave(c, false)}
